...
let rs3 = document.getElementById('rs3')
let rs4 = document.getElementById('rs4')
let rs5 = document.getElementById('rs5')
let rs6 = document.getElementById('rs6')
let rs7 = document.getElementById('rs7')
// end ranks
...
let o12 = document.getElementById('s1')
let o13 = document.getElementById('s2')
let o14 = document.getElementById('s3')
let o15 = document.getElementById('s4')
let o16 = document.getElementById('s5')
let o17 = document.getElementById('s6')
let o18 = document.getElementById('s7')
// end ovrs
...
let m = [o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11, o12, o13, o14, o15, o16, o17, o18]
console.log(m[6])
for (let z = 0; z < 18; z++) {
...
let overss = [o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11,o12,o13,o14,o15,o16,o17,o18]
...
btn.addEventListener('click', function() {
  ...
  //sub calc
  let n12 = +o12.value - rs1.value
  let n13 = +o13.value - rs2.value
  let n14 = +o14.value - rs3.value
  let n15 = +o15.value - rs4.value
  let n16 = +o16.value - rs5.value
  let n17 = +o17.value - rs6.value
  let n18 = +o18.value - rs7.value
  let ovrssubs = [n12,n13,n14,n15,n16,n17,n18]
  let rankssubs = [+rs1.value,+rs2.value,+rs3.value,+rs4.value,+rs5.value,+rs6.value,+rs7.value]
  let arrovr = []
  let rankarr = []
  for(let i = 11;i < 18;i++){
    if(overss[i].value > 0 && overss[i].value.length > 0){
      arrovr.push(ovrssubs[i - 11])
      rankarr.push(rankssubs[i - 11])
    }
  }
  let subovr = 0
  let subrank = 0
  subs = arrovr.length
  for(let i = 0;i < arrovr.length;i++){
    subovr += arrovr[i]
    subrank += rankarr[i]
  }
  totalovr += subovr
  totalrank += subrank
  let ovrt = Math.ceil(totalovr / (11 + arrovr.length))
  let rankt = Math.ceil(totalrank / (11 + rankarr.length))
  rankp = rankt
  ovr = ovrt + rankt
  let ovrde = (totalovr - 1) % (11 + arrovr.length)
  ovrremain = (11 + arrovr.length) - ovrde
  let rankde = (totalrank - 1) % (11 + rankarr.length)
  rankremain = (11 + rankarr.length) - rankde
  ovrfinal = ovr
  rankvr = totalrank
  ovvr = ovrremain
  if (totalrank == 0) {
...
btnouvr.addEventListener('click', function() {
  ...
  if (ouvr.value <= 0) {
    ...
    let total = rankrem + (dif * (11 + subs))
    let maxi = Math.ceil(((45 + 4 * subs) - rankvr) / 11)
    if (maxi < 0) { maxi = 0 }
    let maxior = ovrfinal + maxi
    if ((total + rankvr) > (45 + 4 * subs)) {
